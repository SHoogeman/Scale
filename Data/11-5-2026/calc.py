...
path = os.getcwd() 
data_path = path + fr"\Scale\Data\11-5-2026\datalog.txt"
...
axes[0].plot(T_graph, Pressure1, label="Pressure output")
axes[0].plot(T_graph, Pressure2, label="Pressure input")    
axes[0].set_xlabel("Time")
axes[0].set_ylabel("Pressure (Pa)") 
axes[0].legend()

axes[1].plot(T_graph, Temp1, label="Temperature output")
axes[1].plot(T_graph, Temp2, label="Temperature input")
axes[1].set_xlabel("Time")
axes[1].set_ylabel("Temperature (°C)")
axes[1].legend()

axes[2].plot(T_graph, relative_humidity1, label="Relative Humidity output")
axes[2].plot(T_graph, relative_humidity2, label="Relative Humidity input")
...
axes[4].plot(T_graph, amp, label="Amperes (A)")
axes[4].set_xlabel("Time")  
axes[4].set_ylabel("Amperes (A)")
axes[4].legend()
...
axes[5].legend()
plt.tight_layout()
plt.savefig("4-5-2026.png", dpi=800)
plt.show()